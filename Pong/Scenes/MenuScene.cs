    ...
    class MenuScene : Component
    {
        ...
        internal override void LoadContent(ContentManager Content)
        {
            ...
            for (int i = 0; i < btns.Length; i++)
            {
                ...
                // Center screen, and offset by increment value, Set title to height desired, first button starts at 300
        ...
        internal override void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(title, new Vector2(Data.ScreenW / 2 - 200, 0), Color.White);
        }
    }
}
